...
const ContactUs = (props) => {
	...
	return (
		<DefaultLayout>
			...
			<Heading
				title="Wanna share ideas about campervan build out?"
				subtitle="I would love to hear from you., Just fill the form below and I will get in touch with you soon."
			/>
